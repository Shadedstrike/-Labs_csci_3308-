...
// / https://api.weatherstack.com/forecast?access_key={key}&query={latitude},{longitude}&forecast_days={number_of_days}
  var url = 'https://api.weatherstack.com/forecast?access_key=5bc82451636190abd9d7afe6fe9b20b5&query=Boulder&forecast_days=1';
...
//jquery it up
      ...
      console.log("after jquerey image");//View Today's Temp


        /*2. location: This should be appended to the heading. For eg: "Today's Weather Forecast - Boulder"*/

        $("#heading").attr("src", data.current.location[0]);
